    ...
    return (
        <div className='absolute w-full h-full flex justify-center items-center flex-col px-8 text-center'>
          ...
          `}>
                ...
                {props.gameState === 'loading' ? 'Loading neural network...' : 'Play Game'}
            </button>
